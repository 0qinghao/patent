function ycbcr = rgb2ycbcr(varargin)
    ...
    % ycocg
    % kr = 0.25; kg = 0.5; kb = 0.25;
    % test
    % kr = 0.2; kg = 0.6; kb = 0.2;
    % kr = 0.5; kg = 0.25; kb = 0.25;
    % kr = 0.25; kg = 0.25; kb = 0.5;
    % kr = 1/3; kg = 1/3; kb = 1/3;

    origT = [0.25 0.5 0.25; -0.25 0.5 -0.25; 0.5 0 -0.5] * 255;
    % origT = [0.25 0.5 0.25; 0.5 0 -0.5; -0.25 0.5 -0.25] * 255;
    % origT = [0.25 0.5 0.25; 0 0.5 -0.5; 0.5 -0.25 -0.25] * 255;
    % origT = [0.25 0.5 0.25; -0.125 0.5 -0.375; 0.75 0 -0.25] * 255;
    ...
    %         0.5, -0.5 * (kg / (1 - kr)), -0.5 * (kb / (1 - kr))] * 255;
    % origOffset = [0; 128; 128];
