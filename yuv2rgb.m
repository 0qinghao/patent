function rgb = ycbcr2rgb(varargin)
    ...
    T = [0.25 0.5 0.25; -0.25 0.5 -0.25; 0.5 0 -0.5] * 255;
    % T = [0.25 0.5 0.25; 0.5 0 -0.5; -0.25 0.5 -0.25] * 255;
    % T = [0.25 0.5 0.25; 0 0.5 -0.5; 0.5 -0.25 -0.25] * 255;
    % T = [0.25 0.5 0.25; -0.125 0.5 -0.375; 0.75 0 -0.25] * 255;
